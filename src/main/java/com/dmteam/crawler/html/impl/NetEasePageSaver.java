 ...
 */
public class NetEasePageSaver extends SimplePageSaver {

    private static Pattern fileNamePattern = Pattern.compile("^(.*).163.com_\\d{2}_\\d{4}_\\d{2}_[A-Z0-9]+(_\\d{1,2})?.html.txt$");
